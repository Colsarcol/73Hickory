  ...
  function render() {
    ...
    app.innerHTML = `
      <div class="hero" id="top">
        <div class="bg${c.hero.fit === 'contain' ? ' bg-blur' : ''}" style="background-image:url('${esc(c.hero.image)}');background-position:center ${Number(c.hero.focus ?? 65)}%"></div>
        ${c.hero.fit === 'contain' ? `<div class="bg bg-fit" style="background-image:url('${esc(c.hero.image)}')"></div>` : ''}
